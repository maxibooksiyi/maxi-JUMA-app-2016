...
public class StepCounterActivity extends Activity {
	...
	//public static int menu_settings;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.walk);  //设置当前屏幕
...
*/
	...
	private void addView() {
		...
		btn_start = (Button) this.findViewById(R.id.start1);
		btn_stop = (Button) this.findViewById(R.id.stop1);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.ment_information:   //case后面必须跟常量
			break;
		}
